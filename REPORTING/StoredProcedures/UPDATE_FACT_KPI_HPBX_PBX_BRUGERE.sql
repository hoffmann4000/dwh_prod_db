...
PRINT 'Updates the KPI "One-Connect-brugere i alt" I REPORTING.FACT_KPI';

MERGE REPORTING.FACT_KPI T
	USING 
	(
	SELECT 
	SUM(USERS) AS REALISERET, 
	...
	--SUM AND GROUP BY AS A PARTNER CAN HAVE CUSTUMERS IN MORE THAN ONE CONNECT DATABASE
	) S
