CREATE TABLE [BASELINE].[cvr_data] (
    [CVR]                       INT            NOT NULL,
    [NAME]                      NVARCHAR (50)  NOT NULL,
    [MAIN_INDUSTRY_CODE]        NVARCHAR (50)  NOT NULL,
    [MAIN_INDUSTRY_DESCRIPTION] NVARCHAR (100) NOT NULL,
    [STATUS]                    NVARCHAR (50)  NOT NULL,
    [STREET]                    NVARCHAR (50)  NOT NULL,
    [NUMBER_FROM]               NVARCHAR (50)  NOT NULL,
    ...
    [STOPPED]                   DATETIME2 (7)  NULL,
    CONSTRAINT [PK_cvr_data] PRIMARY KEY CLUSTERED ([CVR] ASC)
);
