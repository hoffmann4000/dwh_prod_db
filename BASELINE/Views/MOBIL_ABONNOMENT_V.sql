...
AS
--FRA ADMIN.MOBIL_ADN 
SELECT ABN.ID AS ABN_ID, ABN.CUST, ABN.COUNTRY_ID, DID AS MOBIL_NR, ABN.NAVN, ABN.EXTRA, ABN.ABN, R.DESCR AS ABN_NAME, ABN.STARTDATE, ABN.ENDDATE, ABN.ICC, ABN.SUSPENDED, 
--FRA ADMIN.ICC
