...
SELECT ABN.ID AS ABN_ID, ABN.CUST, ABN.COUNTRY_ID, DID AS MOBIL_NR, ABN.NAVN AS ABN_NAME, ABN.EXTRA, ABN.ABN, R.DESCR, ABN.STARTDATE, ABN.ENDDATE, ABN.ICC, ABN.SUSPENDED, 
--FRA ADMIN.ICC
