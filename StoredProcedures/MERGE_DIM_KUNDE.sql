CREATE PROCEDURE [REPORTING].[MERGE_DIM_KUNDE]
AS

BEGIN
IF OBJECT_ID('REPORTING.DIM_KUNDE', 'U') IS NOT NULL 

PRINT 'MERGE REPORTING.DIM_KUNDE'
MERGE INTO REPORTING.DIM_KUNDE AS T
	...
	FORHANDLERPOSTNR,
	FORHANDLERKOMMUNE,
	KONKURS_INKASSO_DUBIØS
	FROM BASELINE.DIM_KUNDE_V) 
	AS S
...
WHEN MATCHED THEN 
   UPDATE SET 
	...
	T.KONKURS_INKASSO_DUBIØS=S.KONKURS_INKASSO_DUBIØS
...
UPDATE REPORTING.DIM_KUNDE
SET 
KUNDENAVN='Ukendt', 
FORHANDLERNAVN='Ukendt'
WHERE KUNDE_ID=-1;
