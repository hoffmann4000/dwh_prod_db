CREATE PROCEDURE [REPORTING].[MERGE_FACT_CHURN]
...
PRINT ('MERGE STATEMENT - NUMBER OF ACTIVE CUSTOMERS');
	...
	WHEN NOT MATCHED BY TARGET
		THEN INSERT (PARTNER_ID, NUMBER_OF_ACTIVE_CUSTOMERS, DATE_ID)
		VALUES (S.PARTNER_ID, S.NUMBER_OF_ACTIVE_CUSTOMERS, S.DATE_ID);
...
PRINT ('MERGE STATEMENT - NUMBER OF CHURNED CUSTOMERS');
	...
	WHEN NOT MATCHED BY TARGET
		THEN INSERT (PARTNER_ID, NUMBER_OF_CHURNED_CUSTOMERS, DATE_ID)
		VALUES (S.PARTNER_ID, S.NUMBER_OF_CHURNED_CUSTOMERS, S.DATE_ID);
...
PRINT ('MERGE STATEMENT - NUMBER OF OFFERS');
	...
	WHEN NOT MATCHED BY TARGET
		THEN INSERT (PARTNER_ID, NUMBER_OF_OFFERS, DATE_ID)
		VALUES (S.PARTNER_ID, S.NUMBER_OF_OFFERS, S.DATE_ID);
...
PRINT ('DELETE AND INSERT OF HISTORIC DATA');

	DELETE FROM REPORTING.FACT_CHURN WHERE PARTNER_ID=999;

	INSERT INTO REPORTING.FACT_CHURN (PARTNER_ID, DATE_ID, FISCAL_YEAR_START_DT, NUMBER_OF_MONTHS_PASSED, NUMBER_OF_CHURNED_CUSTOMERS, NUMBER_OF_OFFERS, NUMBER_OF_ACTIVE_CUSTOMERS, FIRST_DEVISION, CHURN_PCT)
	VALUES 
	(999,	'2018-06-30',	'2017-07-01',	12,	NULL,	NULL,	NULL,	NULL,	10.7000000000),
	(999,	'2019-06-30',	'2018-07-01',   12,	NULL,	NULL,	NULL,	NULL,	10.5500000000),
	(999,	'2020-06-30',	'2019-07-01',	12,	NULL,	NULL,	NULL,	NULL,	10.3000000000),
	(999,	'2021-06-30',	'2020-07-01',	12,	702,	62,	    7079,	NULL,	9.0000000000);
